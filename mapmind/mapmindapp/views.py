...
def fig_to_file(fig):
    """
    Displays a matplotlib figure as an iframe using mpld3.

    Parameters:
    fig (matplotlib.figure.Figure): The matplotlib figure to display.

    Returns:
    str: The HTML iframe string to display the figure.
    """
    # Convert the matplotlib figure to a PNG image
    html_str = mpld3.fig_to_html(fig)
    Html_file= open("vis.html","w")
